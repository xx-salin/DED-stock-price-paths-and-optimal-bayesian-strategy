...
buy_info = 1.2  # price of buying info (feasible range important for E_Payoff calc & condition 1, find in requirement conditions section)
...
E_CG_p2_up2far = p_type0_p2info_up2far * E_CG_type0_phase2 + 0 + 0 
E_CG_p3_up2far = p_type0_p2info_up2far * E_CG_type0_phase3 + 0 + 0
...
E_CG_p2_down2close = p_type0_p2info_down2close * E_CG_type0_phase2 + 0 + 0 
E_CG_p3_down2close = p_type0_p2info_down2close * E_CG_type0_phase3 + 0 + 0
...
E_CG_p2_up2close = p_type1_p2info_up2close * E_CG_type1_phase2 + p_type2_p2info_up2close * E_CG_type2_phase2 + 0 
E_CG_p3_up2close = p_type1_p2info_up2close * E_CG_type1_phase3 +  p_type2_p2info_up2close * E_CG_type2_phase3 + 0
...
E_CG_p2_down2far = p_type2_p2info_down2far * E_CG_type2_phase2 + 0 + 0 
E_CG_p3_down2far = p_type2_p2info_down2far * E_CG_type2_phase3 + 0 + 0
...
E_CG_p2_up1up2far = p_type0_p12info_up1up2far * E_CG_type0_phase2 + 0 + 0 
E_CG_p3_up1up2far = p_type0_p12info_up1up2far * E_CG_type0_phase3 + 0 + 0
...
E_CG_p2_up1down2close = p_type0_p12info_up1down2close * E_CG_type0_phase2 + 0 + 0 
E_CG_p3_up1down2close = p_type0_p12info_up1down2close * E_CG_type0_phase3 + 0 + 0
...
E_CG_p2_down1up2close = p_type1_p12info_down1up2close * E_CG_type1_phase2 + p_type2_p12info_down1up2close * E_CG_type2_phase2 + 0 
E_CG_p3_down1up2close = p_type1_p12info_down1up2close * E_CG_type1_phase3 + p_type2_p12info_down1up2close * E_CG_type2_phase3 + 0
...
E_CG_p2_down1down2far = p_type2_p12info_down1down2far * E_CG_type2_phase2 + 0 + 0
E_CG_p3_down1down2far = p_type2_p12info_down1down2far * E_CG_type2_phase3 + 0 + 0
...
print('-----------------------------------------------------------------------------------------------')
print('-----------------------------------------------------------------------------------------------')
print('Raw Unconditional Expected Capital Gains / Expected Price, by stock type & phase')
print('-----------------------------------------------------------------------------------------------')
print('-----------------------------------------------------------------------------------------------')
print('-----------------------------------------------------------------------------------------------')
...
print('Phase 2 Info: Down, Close - infer type0') # ordinal ranking of ECG for possible info scenarios (ie in reality up2far ECG > down2close ECG since known/inferred if P1 was good or bad state). I believe (NEEDS PROPER CHECKING) I still need to incorporate this properly into optimal ranked strategy calcs, should hopefully arbitrary for ordinal rankings for now.
#print(ranked_E_CG_down2close)
